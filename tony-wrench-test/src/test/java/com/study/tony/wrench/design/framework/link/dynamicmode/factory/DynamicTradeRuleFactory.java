package com.study.tony.wrench.design.framework.link.dynamicmode.factory;

import com.study.tony.wrench.design.framework.link.dynamicmode.LogicChainArmory;
import com.study.tony.wrench.design.framework.link.dynamicmode.chain.BusinessLogicChain;
import com.study.tony.wrench.design.framework.link.dynamicmode.logic.DynamicRuleLogic01;
import com.study.tony.wrench.design.framework.link.dynamicmode.logic.DynamicRuleLogic02;
import com.study.tony.wrench.design.framework.link.dynamicmode.logic.XxxResponse;
import lombok.*;
...
public class DynamicTradeRuleFactory {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class DynamicContext extends com.study.tony.wrench.design.framework.link.dynamicmode.DynamicContext {
        private String age;
    }
